...
export default function MobileNav() {
  ...
  return (
    <>
      {/* Top Bar - Level Badge + Menu Button */}
      <div className="fixed top-4 right-4 z-50 flex items-center gap-2">
        {/* Level Badge */}
        <LevelBadge compact className="shadow-lg dark:shadow-dark-md" />

        {/* Menu Button */}
        <button
          onClick={() => setIsOpen(!isOpen)}
          className="p-3 bg-white dark:bg-dark-card rounded-lg shadow-lg dark:shadow-dark-md border border-gray-200 dark:border-dark-border hover:bg-gray-50 dark:hover:bg-dark-card-soft active:scale-95 transition-all"
