            ...
            <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="bg-white rounded-lg p-3">
                  ...
                  <p className="text-2xl font-bold text-blue-600">{remaining.problems}</p>
                </div>
                <div className="bg-white rounded-lg p-3">
                  <p className="text-gray-600">Hints</p>
                  <p className="text-2xl font-bold text-blue-600">{remaining.hints}</p>
                </div>
                <div className="bg-white rounded-lg p-3">
                  <p className="text-gray-600">Prerequisites</p>
                  <p className="text-2xl font-bold text-blue-600">{remaining.prerequisites}</p>
                </div>
                <div className="bg-white rounded-lg p-3">
                  <p className="text-gray-600">Reflections</p>
                  <p className="text-2xl font-bold text-blue-600">{remaining.reflections}</p>
                </div>
              </div>
            </div>
    ...
    <div>
      <div className="fixed top-4 right-4 z-50">
        <button
          ...
          className="px-4 py-2 bg-white border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 flex items-center gap-2 text-sm shadow-md"
        >
