...
export default function DemoProblemSelector({
  ...
  const examColors = {
    JEE: { bg: 'bg-blue-100', text: 'text-blue-700', border: 'border-blue-300' },
    NEET: { bg: 'bg-green-100', text: 'text-green-700', border: 'border-green-300' },
    Boards: { bg: 'bg-purple-100', text: 'text-purple-700', border: 'border-purple-300' },
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 mb-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <h4 className="font-medium text-gray-900 mb-1">1. Think First</h4>
          ...
          <div className="text-center">
            ...
            <h4 className="font-medium text-gray-900 mb-1">2. Guided Solving</h4>
            <p className="text-sm text-gray-600">
          ...
          <div className="text-center">
            ...
            <h4 className="font-medium text-gray-900 mb-1">3. Learn From Mistakes</h4>
            <p className="text-sm text-gray-600">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-gray-900">Choose a Problem</h3>
          ...
          {problems.map((problem) => {
            ...
            return (
              <button
                ...
                className="w-full text-left bg-white rounded-xl shadow-md p-6 border border-gray-200 hover:shadow-lg hover:border-indigo-300 transition-all group"
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="mt-3 text-sm text-indigo-600 font-medium group-hover:text-indigo-700">
