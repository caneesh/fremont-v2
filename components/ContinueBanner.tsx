      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-accent/10 dark:to-indigo-900/20 border border-blue-200 dark:border-accent/30 rounded-xl p-4 md:p-5 shadow-sm dark:shadow-dark-sm">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-3 flex-1 min-w-0">
            {/* Icon */}
            <div className="flex-shrink-0 w-10 h-10 bg-blue-100 dark:bg-accent/20 rounded-full flex items-center justify-center">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-sm font-semibold text-blue-900 dark:text-accent mb-1">
                Continue where you left off
              </h3>
              <p className="text-sm text-blue-800 dark:text-dark-text-primary truncate font-medium">
                {inProgressProblem.problemTitle}
              </p>
              <div className="flex items-center gap-3 mt-2 text-xs text-blue-600 dark:text-dark-text-secondary">
              ...
              {/* Progress bar */}
              <div className="mt-3 w-full bg-blue-200 dark:bg-dark-card-soft rounded-full h-1.5">
                <div
                  className="bg-blue-600 dark:bg-accent h-1.5 rounded-full transition-all duration-300"
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <button
              ...
              className="px-4 py-2 bg-accent text-white text-sm font-medium rounded-lg hover:bg-accent-strong transition-all shadow-sm hover:shadow-md dark:shadow-dark-glow"
            >
              Resume
            </button>
            <button
              onClick={() => setIsDismissed(true)}
              className="p-2 text-blue-400 dark:text-dark-text-muted hover:text-blue-600 dark:hover:text-dark-text-secondary hover:bg-blue-100 dark:hover:bg-dark-card-soft rounded-lg transition-colors"
              aria-label="Dismiss"
            >
